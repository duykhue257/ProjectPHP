...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($success) {
        $sql = "INSERT INTO caterories(cate_name ) 
    VALUES ('$cate_name')";
...
<body>
    ...
    <form action="" method='post' class="max-w-lg mx-auto">
        <div class="mb-4">
            ...
            <input type="text" name='cate_name' class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="username" type="text" placeholder="Enter your username">
        </div>
